<template>
  ...
  >
    ...
    <div v-if="mode === 'mini' && !isPiP" class="popout-mini" @dblclick="mode = 'expanded'">
      <img v-if="coverUrl" :src="coverUrl" :alt="title" loading="lazy" class="popout-cover" />
    ...
    <div v-else class="popout-expanded">
      <div class="popout-track-info">
        <img v-if="coverUrl" :src="coverUrl" :alt="title" loading="lazy" class="popout-expanded-cover" />
