  ...
  <div class="mx-auto w-full max-w-7xl px-4 pt-6 pb-32 md:px-6 lg:px-8">
    ...
    <div class="relative mb-8">
      ...
      <button
        ...
        class="absolute left-4 top-1/2 -translate-y-1/2 flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-xs text-slate-400 hover:bg-white/20"
        @click="clearSearch"
      >
