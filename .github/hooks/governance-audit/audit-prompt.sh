...
check_pattern "(drop\s+database|truncate\s+table)" "system_destruction" "0.9" "Database destruction"
...
check_pattern "system\s*:\s*you\s+are" "prompt_injection" "0.6" "System prompt injection"
